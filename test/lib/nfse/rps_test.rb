...
describe Nfse::Rps do

  subject { Nfse::Rps.new }
  ...
  describe 'prestador attribute' do
    ...
    it 'must have the right value' do
      subject.prestador.must_be_instance_of Nfse::Prestador
    end
  end
  ...
  describe 'tomador attribute' do
    ...
    it 'must have the right value' do
      subject.tomador.must_be_instance_of Nfse::Tomador
    end
  end
